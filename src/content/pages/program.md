...
## HHMI-Janelia as a partner

HHMI-Janelia hosts the school, and its research is a large part of why the school is there. Much of the data on DANDI was recorded with tools that came out of HHMI-Janelia: the GCaMP indicators from the GENIE project, the Neuropixels probes developed with the Allen Institute and UCL, and the light-sheet and two-photon microscopes built on campus. The same is true of the software the curriculum teaches. Kilosort, suite2p, Cellpose, Facemap, and Rastermap are developed there, and their authors teach at the school. Two of HHMI-Janelia's named research areas, computational tool development and theoretical and computational neuroscience, cover the school's subject matter directly: machine learning that extracts understanding from large recordings, and models of neural computation built on that data. HHMI-Janelia's own labs work at the scale where reanalysis pays off most, with whole-brain imaging in larval zebrafish and chronic recordings from freely moving mice producing datasets far richer than any one group can exhaust, and the campus describes its aim as sharing everything it does, tools, data, and methods included, with scientists everywhere. Hosting the school there means participants spend the week among the people who build the instruments, write the software, and collect the data they are learning to reuse, and the laboratory tour and guest lectures come from those same labs.
